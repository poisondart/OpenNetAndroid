...
public class BoardFragment extends Fragment {
    ...
    private String mLink = Links.MAIN_BOARD_RSS_LINK;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.board_fragment_layout, container, false);
        mNewsItems = new ArrayList<>();
        mToolbar = v.findViewById(R.id.toolbar_board);
        mRecyclerView = v.findViewById(R.id.board_recyclerview);
        ...
        actionBar.setTitle(R.string.board_title);
        new FetchFeedTask(BoardFragment.this, mLink).execute();
    ...
    private static class FetchFeedTask extends AsyncTask<Integer, Void, Integer> {
        ...
        private FetchFeedTask(BoardFragment context, String link) {
